...
with(powerdata, {
  #
  plot(powerdata$datetime, powerdata$active_power, type = "l", xlab = " ", ylab = "Global Active Power")
  #
  plot(powerdata$datetime, powerdata$voltage, type = "l", xlab = "datetime", ylab = "Voltage")
  #
  plot(powerdata$datetime, powerdata$submeter1, type = "l", col = "black", xlab = " ", ylab = "Energy Sub Metering") 
  ...
  #
  plot(powerdata$datetime, powerdata$reactive_power, type = "l", xlab = "datetime", ylab = "Global Reactive Power")
})
dev.off()
